...
tbl_uvregression(
	nlsy,
	y = nsibs,
	include = c(race_eth_cat, eyesight_cat, income),
	method = glm,
...
# fit a poisson regression to create RISK RATIOS
tbl_uvregression(
	nlsy,
	y = glasses,
...
# fit a poisson regression using Poisson instead of the log-binomial (=binomial (link= "log))
